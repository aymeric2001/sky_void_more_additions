...
execute unless score deepslate_from_clay skyvoid_config matches 0..1 run scoreboard players set deepslate_from_clay skyvoid_config 0
...
execute unless score tuff_from_basalt skyvoid_config matches 0..1 run scoreboard players set tuff_from_baslt skyvoid_config 0
